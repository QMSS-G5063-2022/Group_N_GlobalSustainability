  ...
  tabPanel("Intro", style = "padding-top:75px",
           ...
           fluidRow(column(width = 4, style = "padding-bottom:50px",
                    ...
                    column(width = 4, style = "padding-bottom:50px",
                           h2("David Liang",
                              style = "text-align:center"),
                           img(src = "David.png", align = "left", height = "320px", width = "325px", style = "display: inline-block; margin-left: 15%; margin-right: 15%; padding-bottom:20px"),
                           br(),
